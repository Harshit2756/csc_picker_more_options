...
class CSCPicker extends StatefulWidget {
  ...
  final TextStyle? selectedItemStyle, unselectedItemStyle, dropdownHeadingStyle, dropdownItemStyle, labelStyle;
...
class CSCPickerState extends State<CSCPicker> {
  ...
  Future<List<String?>> getStates() async {
    ...
    var takeState = widget.flagState == CountryFlag.ENABLE || widget.flagState == CountryFlag.SHOW_IN_DROP_DOWN_ONLY
        ? response.map((map) => Country.fromJson(map)).where((item) => item.emoji + "    " + item.name == _selectedCountry).map((item) => item.state).toList()
  ...
  Widget countryDropdown() {
    return DropdownWithSearch(
      ...
      unselectedItemStyle: widget.unselectedItemStyle, // Added this line
